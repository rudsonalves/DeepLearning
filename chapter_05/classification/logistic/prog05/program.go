...
Training and testing the locistic regression

To obtimize weights is used Stochastic Gradient Descent

*/

// logistic implements the logistic function, wich is used in
// logistic regression
...
func logisticRegression(features *mat64.Dense, labels []float64, numSteps int, learningRate float64) []float64 {
	...
	for i := 0; i < numSteps; i++ {
		// Initialize a variable to assumulate error for this iteration
